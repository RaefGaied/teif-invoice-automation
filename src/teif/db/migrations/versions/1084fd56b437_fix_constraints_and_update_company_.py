"""Fix constraints and update company models

Revision ID: 1084fd56b437
Revises: 238ba371b20d
Create Date: 2025-09-16 11:52:22.227292
...
def downgrade():
    ...
    # Add back the original default constraint if needed
    op.alter_column('companies', 'updated_at',
